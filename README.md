...
To add Duper for `v4.29.0` to an existing project with a `lakefile.toml` file, add the following dependency:
...
```lean
require Duper from git "https://github.com/leanprover-community/duper.git" @ "v4.29.0"
```
